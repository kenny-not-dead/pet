...
const sentenceList = () => {
    ...
    sentences.innerHTML = sentenceArray.slice(i1,i2).map(i => 
        ` <li class="sentence">
...
const newsList = () => {
    contentInfo.innerHTML = newsArray.slice(n1, n2).map(i => `
...
const serviceList = () => {
    ...
    const card = document.querySelector('.cards');
    card.innerHTML = serviceArray.map(i => 
    ` <li class="card">
    <img src=${i.img} class='card-img' alt="Photo">
    <div class="info">
        <h3 class="info-h3">${i.h3}</h3>
